...
La aplicación es un gestor de tiempo que permite a los usuarios registrar y monitorear el tiempo dedicado a tareas específicas en un entorno de trabajo.<br>
El objetivo de esta aplicación es ayudar a los usuarios a aumentar su productividad y eficiencia en el trabajo.
...
- Hacer commit de los cambios: `git commit -m "Agrega nueva funcionalidad"`
